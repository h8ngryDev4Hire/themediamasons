...
//}
var CallToAction = forwardRef(function CallToAction(_a, ref) {
    var visible = _a.visible;
    return (<section id="demo-section" className={"w-full flex flex-col items-center justify-center p-[1rem] space-y-[5rem]"} ref={ref}>
		{visible ? (<>
			<Headline message={<div className="flex flex-col">
 					<span>
			...
			<div id="" className={"flex w-full h-[5rem] justify-center items-center"}>
				<CtaButton message={'Schedule Now!'} modalId={SIGNATURE} metadata={"custom"}/>			
			</div>
