...
var MatrixScape = dynamic(function () { return import('@components/three/matrixscape.tsx'); }, { ssr: false });
export default function Hero() {
    return (<header id="hero" className=" w-full min-h-[45rem] z-content items-center justify-center">
